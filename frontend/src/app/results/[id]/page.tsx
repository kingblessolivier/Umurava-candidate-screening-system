                      ...
                      <div className="border-b border-gray-200">
                        <div className="px-3 py-2 bg-red-50 border-b border-red-200">
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <span className="text-[8px] font-mono font-bold px-1.5 py-0.5 bg-white text-purple-700 border border-purple-200">
          ...
          <td colSpan={7} className="p-0">
            <div className="border-t border-red-200 bg-red-50 p-4 space-y-4">
              <div className="border border-red-200 bg-white">
                <div className="px-3 py-2 border-b border-red-200 flex items-center justify-between gap-2 bg-white">
                  <p className="text-[9px] font-bold uppercase tracking-widest text-red-600 flex items-center gap-1.5">
